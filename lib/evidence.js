...
import { confirmerOf, deriveStatuses, readConfirmations } from './confirm.js';
...
export function countEvidence(entries = []) {
  ...
  return { total: list.length, byKind, unverified, lowConfidence };
}
...
export function formatEvidence(report) {
  ...
  const c = counts ?? { total: 0, byKind: {}, unverified: 0, lowConfidence: 0 };
